...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'service',
                    models.CharField(
                        choices=[('discord', 'Discord'), ('battle_net_us', 'Battle.net US')],
                        max_length=64,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'client',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='oauth2.Client', verbose_name='client'
                    ),
                ),
                (
                    'user',
        ...
        migrations.AlterUniqueTogether(name='token', unique_together={('user', 'client', 'resource_id')}),
    ]
